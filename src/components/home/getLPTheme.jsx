...
const getDesignTokens = (mode) => ({
  palette: {
    ...
    alert: {
      success: "#4CAF50", // Custom success alert color
      error: "#F44336", // Custom error alert color
      warning: "#FFC107", // Custom warning alert color
      info: "#2196F3", // Custom info alert color
    },
    text: {
      primary: gray[800],
      secondary: gray[600],
    ...
    link: {
      primary: gray[200],
      active: "white",
      fprim: "rgba(173, 181, 189, 1)",
      fsec: "rgba(233, 236, 239, 1)",
    },
...
export default function getLPTheme(mode) {
  return {
    ...
    components: {
      ...
      MuiAccordionSummary: {
        defaultProps: {
          expandIcon: <AddIcon />, // Using AddIcon as the default expand icon
        },
